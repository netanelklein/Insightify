...
void main() {
  group('Input Validation Integration Tests', () {
    ...
    test('should sanitize search input', () {
      ...
      expect(InputValidator.sanitizeSearchQuery('Song\x00\x1F\x7F'), equals('Song'));
    ...
    test('should validate file paths securely', () {
      ...
      expect(InputValidator.sanitizeFilePath('../../../etc/passwd.json', ['json']), 
    ...
    test('should sanitize display text', () {
      ...
      expect(InputValidator.sanitizeForDisplay('Text\x00\x08\x0B\x0C'), equals('Text'));
