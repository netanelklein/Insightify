...
void main() {
  group('ErrorReportingService', () {
    ...
    setUp(() {
      ...
      errorReporting.debugLoggingEnabled = false; // Disable console output during tests
    });
    ...
    group('Basic Logging', () {
      ...
      test('should log warnings', () {
        errorReporting.warning('Test warning', category: ErrorCategory.userInput);
    ...
    group('Context and Enrichment', () {
      ...
      test('should handle input validation errors without logging sensitive data', () {
        errorReporting.inputValidationError('Invalid email format',
            fieldName: 'email',
            inputValue: 'user@invalid');
    ...
    group('Error History Management', () {
      test('should limit error history size', () {
        ...
        expect(errors.last.message, equals('Error ${ErrorReportingService.maxErrorHistory + 9}'));
      });
      ...
      test('should filter errors by minimum level', () {
        ...
        final warningAndAbove = errorReporting.getRecentErrors(minLevel: LogLevel.warning);
    ...
    group('Error Statistics', () {
      test('should calculate error statistics correctly', () {
        ...
        expect(stats['byCategory']['system'], equals(3)); // debug(2) + info(1) default to system
        expect(stats['byCategory']['unknown'], equals(1)); // warning defaults to unknown
      });
    });
